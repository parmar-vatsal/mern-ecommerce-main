...
const Dashboard = () => {
	...
	const { stats, loading, error } = useSelector((state) => state.dashboardStats);
                      ...
                      <div className="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
                          ...
                          <div className="col-sm-12">
                            <div className="statistics-details d-flex align-items-center justify-content-between">
                              <div>
                                ...
                                <h3 className="rate-percentage">{stats.totalUsers || 0}</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-up" /><span>+0.1%</span></p>
                              </div>
                              <div>
                                <p className="statistics-title">Total Products</p>
                                <h3 className="rate-percentage">{stats.totalProducts || 0}</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-up" /><span>+0.1%</span></p>
                              </div>
                              <div>
                                <p className="statistics-title">Total Orders</p>
                                <h3 className="rate-percentage">{stats.totalOrders || 0}</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-up" /><span>+0.1%</span></p>
                              </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Total Revenue</p>
                                <h3 className="rate-percentage">₹{stats.totalRevenue ? stats.totalRevenue.toLocaleString() : '0.00'}</h3>
                                <p className="text-success d-flex"><i className="mdi mdi-menu-up" /><span>+0.8%</span></p>
                              </div>
                              <div className="d-none d-md-block">
                                <p className="statistics-title">Total Orders</p>
                                <h3 className="rate-percentage">{stats.totalOrders || 0}</h3>
                        ...
                        <div className="d-sm-flex align-items-center mt-1 justify-content-between">
                          <div className="d-sm-flex align-items-center mt-4 justify-content-between">
                            <h2 className="me-2 fw-bold">₹{stats.totalRevenue ? stats.totalRevenue.toLocaleString() : '0.00'}</h2>
                            <h4 className="me-2">INR</h4>
